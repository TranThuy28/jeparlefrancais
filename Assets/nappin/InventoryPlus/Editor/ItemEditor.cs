...
//         public SerializedProperty _itemPrefab;
//         public SerializedProperty _itemChapter;
...
//             _itemChapter = serializedObject.FindProperty("itemChapter");
...
//             _itemPrefab.objectReferenceValue = (GameObject)EditorGUILayout.ObjectField(script.itemPrefab, typeof(GameObject), allowSceneObjects: true, GUILayout.Height(200f), GUILayout.Width(200f));
...
//             EditorGUILayout.Space(20);
//             #region Item Chapter
//             EditorGUILayout.LabelField("Chapter", EditorStyles.boldLabel);
//             _itemChapter.enumValueIndex = (int)(Item.itemChapter)EditorGUILayout.EnumPopup("Chapter", script.itemChapter);
//             #endregion
